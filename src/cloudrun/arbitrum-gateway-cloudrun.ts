...
const ARBITRUM_READ_METHODS = [
  ...
  "eth_getBlockTransactionCountByHash", "eth_getBlockTransactionCountByNumber", "eth_getBlockReceipts",
  ...
  "arb_blockNumber", "arb_getL1BaseFeeEstimate", "arb_getL1GasPriceEstimate",
  "arb_getPricesInWei", "arb_estimateRetryableTicketGasLimit",
];

const ARBITRUM_WRITE_METHODS = ["eth_sendRawTransaction", "eth_sendTransaction"];
...
const ALL_ARBITRUM_METHODS = [
  ...ARBITRUM_READ_METHODS, ...ARBITRUM_WRITE_METHODS,
  ...ARBITRUM_DEBUG_METHODS, ...ARBITRUM_TRACE_METHODS,
];
